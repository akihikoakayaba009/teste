...
document.addEventListener("DOMContentLoaded", function () {
  ...
  const ligas = {
      ...
      bronze: {
          ...
          2: "../imagens/elos/bronze2.png",
          3: "../imagens/elos/bronze3.png"
      },
      prata: {
          1: "../imagens/elos/prata 1.png",
          2: "../imagens/elos/prata 2.png",
          3: "../imagens/elos/prata 3.png"
      },
      ouro: {
          1: "../imagens/elos/ouro 1.png",
          2: "../imagens/elos/ouro 2.png",
          3: "../imagens/elos/ouro 3.png"
      },
      platina: {
          1: "../imagens/elos/platina 1.png",
          2: "../imagens/elos/platina 2.png",
          3: "../imagens/elos/platina 3.png"
      },
      diamante: {
          1: "../imagens/elos/diamante 1.png",
          2: "../imagens/elos/diamante 2.png",
          3: "../imagens/elos/diamante 3.png"
      },
      ascendente: {
          1: "../imagens/elos/ascendente1.png",
          2: "../imagens/elos/ascendente2.png",
          3: "../imagens/elos/ascendente3.png"
      },
      imortal: {
          1: "../imagens/elos/imortal 1.png",
          2: "../imagens/elos/imortal 2.png",
          3: "../imagens/elos/imortal 3.png"
      },
    
  };

  // Função para atualizar a imagem com base na liga e divisão selecionadas
  function updateImage(eloType, div, imgElement) {
      const liga = document.getElementById(eloType).value;
      const divisao = document.getElementById(div).value;
      const imgPath = ligas[liga][divisao]; // Usando o mapa para buscar o caminho da imagem

      imgElement.src = imgPath; // Atualiza a imagem
  }

  // Adicionando eventos de mudança para as seleções
  document.getElementById("ligaAtual").addEventListener("change", function () {
      updateImage("ligaAtual", "divisaoAtual", document.getElementById("imgEloAtual"));
  });

  document.getElementById("divisaoAtual").addEventListener("change", function () {
      updateImage("ligaAtual", "divisaoAtual", document.getElementById("imgEloAtual"));
  });

  document.getElementById("ligaDesejada").addEventListener("change", function () {
      updateImage("ligaDesejada", "divisaoDesejada", document.getElementById("imgEloDesejado"));
  });

  document.getElementById("divisaoDesejada").addEventListener("change", function () {
      updateImage("ligaDesejada", "divisaoDesejada", document.getElementById("imgEloDesejado"));
  });

  // Atualizando as imagens com a seleção inicial
  updateImage("ligaAtual", "divisaoAtual", document.getElementById("imgEloAtual"));
  updateImage("ligaDesejada", "divisaoDesejada", document.getElementById("imgEloDesejado"));
});

$("#ligaAtual").change(() => {
  let liga = ligaAtual.value;
  let divisao = divisaoAtual.value; // Pega a divisão

  // Verifica se a liga é "imortal2" ou "imortal3" para evitar erro
  if (liga.startsWith("imortal") && (divisao === "2" || divisao === "3")) {
      liga = "imortal1"; // Usa a imagem "imortal1.png" para evitar erro
  }

  document.querySelectorAll("#imgEloAtual").forEach((item) => {
      item.src = `../imagens/elos/${liga}.png`;
  });

  if (liga == "mestre" || liga == "graomestre") {
...
$("#ligaDesejada").change(() => {
  let liga = ligaDesejada.value;
  let divisao = divisaoDesejada.value; // Pega a divisão

  if (liga.startsWith("imortal") && (divisao === "2" || divisao === "3")) {
      liga = "imortal1"; // Usa a imagem "imortal1.png" para evitar erro
  }

  document.querySelectorAll("#imgEloDesejado").forEach((item) => {
      item.src = `../imagens/Elos/${liga}.png`;
  });

  if (["mestre", "graomestre", "desafiante", "radiante"].includes(liga)) {
...
$("#ligaDesejada").change(() => {
  if (trataNome("choice") == "valorant") {
    document.querySelectorAll("#imgEloDesejado").forEach(function (item) {
      item.src = `../imagens/Elos/${ligaDesejada.value}.png`;
    });
  } else {
    document.querySelectorAll("#imgEloDesejado").forEach(function (item) {
      item.src = `../imagens/Elos/${ligaDesejada.value}.png`;
